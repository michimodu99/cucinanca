...
export const STRINGHE = {
  it: {
    ...
    dispensa: {
      ...
      cucina: 'Cosa cucino',
      scegli: 'Scegli tu',
      scegliAiuto: 'Scegli una ricetta che posso fare adesso',
      anche: 'anche: {alias}',
      ...
      prefConta: '{n}',
      prefAiuto: "Le ricette che lo richiedono non te le propongo più. Restano quelle dove è facoltativo, o dove hai un sostituto.",
      ...
      giaEscluso: "{nome} è fra quelli che non mangi: toglilo da «Non mangio» per usarlo.",
    ...
    scegli: {
      ...
      vuoto: 'Con questa dispensa non è pronto niente: a ogni ricetta manca almeno un ingrediente. <a href="{link}">Aggiungine uno</a> e riprova.',
