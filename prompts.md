...
Due parti: **61 ricette con la foto già fatta** (`img/<slug>.webp` esiste) e, in fondo, **39 ricette da generare**. Rilanciando `npm run prompts` dopo aver ottimizzato le foto, la lista in fondo si svuota da sola.
