...
- **Il riso non è più uno solo.** Una voce chiamata "Riso Carnaroli" teneva dentro, come alias, tre risi diversi: il libro scriveva "Riso Carnaroli 70 g" per il bitoque e per il riso saltato, e chi aveva basmati o arroz agulha non veniva riconosciuto. Ora ci sono `riso-lungo` (riso, riso bianco, arroz, agulha, basmati, parboiled) e `riso-carnaroli` (carnaroli, arborio, vialone nano, carolino, riso da risotto). Nove ricette passano al riso lungo, cinque restano al Carnaroli: i tre risotti, risi e bisi, l'arroz doce. Ognuna delle nove tiene il Carnaroli come sostituto con la nota del caso. **Conseguenza voluta**: chi scrive solo "riso" non vede più il risotto ai porcini e alla milanese, perché lì il Carnaroli è `principale` e con un riso lungo quel piatto non viene. In Portogallo il carolino costa un euro, è ovunque, ed è alias del Carnaroli.
...
- Tassonomia: 160 voci. Mai usato direttamente: gorgonzola (piadina e porchetta compaiono solo come sostituti). `risolvi()` capisce plurali e singolari ("pomodori", "cece"). Parole generiche risolte per scelta: "pane" → pane-raffermo, "pollo" → petto-di-pollo, e dal 13/09 "riso" → riso-lungo, che prima andava al Carnaroli.
